    ...
    in
    {
      ...
      options = {
        services.step-ca = {
          ...
          #   '';
          # };
          intermediatePasswordFileNg = lib.mkOption {
      ...
      config = lib.mkIf config.services.step-ca.enable (
        let
          ...
          hasPasswordFile = cfg.intermediatePasswordFileNg != null && cfg.intermediatePasswordFileNg != "";
        in
        {
          ...
          systemd.services."step-ca" = lib.mkForce {
            ...
            serviceConfig = {
              ...
              LoadCredential = lib.mkIf hasPasswordFile "intermediate_password:${cfg.intermediatePasswordFileNg}";
...
{ config, ... }:
{
  flake.modules.nixos.step-ca-custom = module;
  unify.nixos = {
    imports = [ config.flake.modules.nixos.step-ca-custom ];
  };
}
